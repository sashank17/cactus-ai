...
export const StatBoxData = [
    {
        ...
        progress: '0.75',
        percentIncrease: '+14%',
        icon: <PointOfSaleRounded sx={{color: '#047c44', fontSize: '24px'}}/>
    },
    {
        title: '43',
        ...
        progress: '0.42',
        percentIncrease: '+60%',
        icon: <ReceiptRounded sx={{color: '#047c44', fontSize: '24px'}}/>
    },
    {
        title: '99',
        ...
        progress: '0.50',
        percentIncrease: '+18%',
        icon: <PersonAddRounded sx={{color: '#047c44', fontSize: '24px'}}/>
    },
    {
        title: '54',
        ...
        progress: '0.89',
        percentIncrease: '+14%',
        icon: <AddBusinessRounded sx={{color: '#047c44', fontSize: '24px'}}/>
    },
